...
**The notarization wall, stated plainly.** Distributing to third parties _without_ Gatekeeper warnings requires an Apple Developer membership ($99/yr) for signing and notarization. Without it:
