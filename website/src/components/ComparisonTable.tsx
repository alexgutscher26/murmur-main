...
const COMPARISONS: ComparisonRow[] = [
  {
    ...
    HushWrite: "100% On-Device (Zero cloud upload)",
  ...
  },
  {
    ...
    HushWrite: "Physical architecture (Zero bytes sent)",
  ...
  },
  {
    ...
    HushWrite: "Instant local formatting",
    wisprFlow: "Cloud LLM",
  ...
  },
  {
    ...
    HushWrite: "Unlimited on-device dictionary",
  ...
  },
  {
    ...
    HushWrite: "Native macOS & Windows (Metal / DirectML)",
  ...
  {
    feature: "Latency",
    HushWrite: "Under 180 ms (Local GPU)",
  ...
  },
  {
    ...
    HushWrite: "Free & Open Source (MIT)",
...
export function ComparisonTable() {
  const renderCell = (val: string | boolean, isHushWrite = false) => {
    if (typeof val === "boolean") {
      return val ? (
        <span
          className={`inline-flex items-center justify-center w-5 h-5 rounded-full ${isHushWrite ? "bg-emerald-50 text-emerald-700 border border-emerald-200/80" : "bg-neutral-100 text-neutral-700 border border-neutral-200/80"}`}
        >
    ...
    return (
      <span
        className={`text-xs font-mono font-medium ${
          isHushWrite ? "text-neutral-950 font-bold" : "text-neutral-600"
        }`}
      >
        {val}
      </span>
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-neutral-600 text-base sm:text-lg leading-relaxed">
            Cloud tools protect data with privacy policies. HushWrite protects data by keeping your
            ...
            <thead>
              <tr className="border-b border-neutral-200/80 bg-neutral-50/80">
                ...
                <th className="p-4 sm:p-5 text-center w-1/5 bg-emerald-50/50 border-x border-emerald-200/80">
                  <span className="text-xs font-bold text-neutral-950 block">HushWrite</span>
