...
const MODELS: ModelInfo[] = [
  {
    ...
    ramUsage: "200 MB",
    accuracy: 90.0,
    description: "Extremely fast but lower accuracy.",
  ...
  },
  {
    ...
    ramUsage: "2.4 GB",
    accuracy: 99.7,
    description: "Pro model. Peak accuracy across all 99 languages.",
    recommendedFor: "General use.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        {/* Model Tabs Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-2 mb-6 overflow-y-auto max-h-[400px] p-2 bg-neutral-50/50 rounded-xl border border-neutral-200/50">
          {MODELS.map((model) => {
