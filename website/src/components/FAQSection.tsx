...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 relative overflow-hidden border-t border-white/[0.06]">
        ...
        <div className="flex flex-col gap-3">
          {FAQS.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className="rounded-2xl bg-[#0e0e11]/90 backdrop-blur-2xl border border-white/[0.08] hover:border-white/[0.14] overflow-hidden transition-all duration-300 shadow-[0_4px_24px_rgba(0,0,0,0.3)]"
              >
                <button
                  onClick={() => toggle(idx)}
                ...
                >
                  ...
                  <span className={`p-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-zinc-400 transition-transform duration-300 shrink-0 ${isOpen ? "rotate-180 text-white bg-white/[0.1]" : ""}`}>
